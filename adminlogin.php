            ...
            <div class="container">
                <div class="single">		
                    <div class="single-top">
                        <img  src="asset/frontend/images/single.jpg" alt=""/>
                    </div>
                    <div class="top-single">
                        ...
                        <div class="top-comments">
                            ...
                            <div class="met">
                                ...
                                <div class="comments-top-top">
                                    <div class="men" >
                                        <img   src="asset/frontend/images/men.png" alt=""> 
                                    </div>					
                        ...
                        <div class="leave">
                            ...
                            <form>
                                ...
                                <div class="single-grid">
                                    <div class="col-md-6 single-us">
                                        <input type="text" value="Website" onfocus="this.value = '';" onblur="if (this.value == '') {
                                                    this.value = 'Website';
                                                }">
                                    </div>
                                    <div class="col-md-6 single-us">
