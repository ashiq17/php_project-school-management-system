...
<php>
    <head>
        ...
        <script src="asset/frontend/asset/frontend/js/jquery.min.js"></script>
        <!--webfonts-->
                ...
                <div class="portfolio-bottom">
                    <div class="gallery-one two">
                        <div class="col-md-4 gallery-left two">
                            <a href="asset/frontend/images/g1.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                                <img src="asset/frontend/images/g1.jpg" alt="" class="img-responsive zoom-img"/>
                            </a>
                        </div>
                        <div class="col-md-4 gallery-left two">
                            <a href="asset/frontend/images/n1.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                                <img src="asset/frontend/images/n1.jpg" alt="" class="img-responsive zoom-img"/>
                            </a>
                        </div>
                        <div class="col-md-4 gallery-left two">
                            <a href="asset/frontend/images/g2.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                                <img src="asset/frontend/images/g2.jpg" alt="" class="img-responsive zoom-img"/>
                            </a>
                        </div>
                        <div class="col-md-4 gallery-left two">
                            <a href="asset/frontend/images/g3.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                                <img src="asset/frontend/images/g3.jpg" alt="" class="img-responsive zoom-img"/>
                            </a>
                        </div>
                        <div class="col-md-4 gallery-left two">
                            <a href="asset/frontend/images/n2.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                                <img src="asset/frontend/images/n2.jpg" alt="" class="img-responsive zoom-img"/>
                            </a>
                        </div>
                        <div class="col-md-4 gallery-left two">
                            <a href="asset/frontend/images/g4.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                                <img src="asset/frontend/images/g4.jpg" alt="" class="img-responsive zoom-img"/>
                            </a>
                        </div>
                        <div class="col-md-4 gallery-left two">
                            <a href="asset/frontend/images/g2.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                        ...
                        <div class="col-md-4 gallery-left two">
                            <a href="asset/frontend/images/g5.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                                <img src="asset/frontend/images/g5.jpg" alt="" class="img-responsive zoom-img"/>
                            </a>
                        </div>
                        <div class="col-md-4 gallery-left two">
                            <a href="asset/frontend/images/n3.jpg" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                                <img src="asset/frontend/images/n3.jpg" alt="" class="img-responsive zoom-img"/>
                            </a>
                        </div>
                    </div>
                </div>
