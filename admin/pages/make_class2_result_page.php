<?php
if (isset($_POST['class2_result_btn'])) {

    $message = $obj_admin->make_class2_result($_POST);
}
$all_student_roll = $obj_admin->select_all_class2_student_roll();
            ...
            <form class="form-horizontal" action="" method="post" >
                <fieldset>
                    ...
                    <div class="form-actions">
                        <button type="submit" name="class2_result_btn" class="btn btn-primary">Make Result</button>
